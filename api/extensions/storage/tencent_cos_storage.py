...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = geo_config.TENCENT_COS_BUCKET_NAME
        config = CosConfig(
            Region=geo_config.TENCENT_COS_REGION,
            SecretId=geo_config.TENCENT_COS_SECRET_ID,
            SecretKey=geo_config.TENCENT_COS_SECRET_KEY,
            Scheme=geo_config.TENCENT_COS_SCHEME,
        )
