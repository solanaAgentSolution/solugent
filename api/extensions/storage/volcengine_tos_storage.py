...
class VolcengineTosStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = geo_config.VOLCENGINE_TOS_BUCKET_NAME
        self.client = tos.TosClientV2(
            ak=geo_config.VOLCENGINE_TOS_ACCESS_KEY,
            sk=geo_config.VOLCENGINE_TOS_SECRET_KEY,
            endpoint=geo_config.VOLCENGINE_TOS_ENDPOINT,
            region=geo_config.VOLCENGINE_TOS_REGION,
        )
