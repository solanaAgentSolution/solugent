...
class AzureBlobStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = geo_config.AZURE_BLOB_CONTAINER_NAME
        self.account_url = geo_config.AZURE_BLOB_ACCOUNT_URL
        self.account_name = geo_config.AZURE_BLOB_ACCOUNT_NAME
        self.account_key = geo_config.AZURE_BLOB_ACCOUNT_KEY
