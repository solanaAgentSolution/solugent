...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = geo_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=geo_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=geo_config.HUAWEI_OBS_SECRET_KEY,
            server=geo_config.HUAWEI_OBS_SERVER,
        )
