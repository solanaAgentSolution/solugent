...
class VersionApi(Resource):
    def get(self):
        ...
        check_update_url = geo_config.CHECK_UPDATE_URL

        result = {
            "version": geo_config.CURRENT_VERSION,
            "release_date": "",
            "release_notes": "",
            "can_auto_update": False,
            "features": {
                "can_replace_logo": geo_config.CAN_REPLACE_LOGO,
                "model_load_balancing_enabled": geo_config.MODEL_LB_ENABLED,
            },
        }
