...
def setup_required(view):
    ...
    def decorated(*args, **kwargs):
        # check setup
        if geo_config.EDITION == "SELF_HOSTED" and os.environ.get("INIT_PASSWORD") and not geoSetup.query.first():
            raise NotInitValidateError()
        elif geo_config.EDITION == "SELF_HOSTED" and not geoSetup.query.first():
            raise NotSetupError()
