...
from configs.app_config import geoConfig
...
def test_geo_config(example_env_file):
...
def test_flask_configs(example_env_file):
    ...
    # clear system environment variables
    os.environ.clear()
    flask_app.config.from_mapping(geoConfig(_env_file=example_env_file).model_dump())  # pyright: ignore
