...
from core.callback_handler.agent_tool_callback_handler import geoAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import geoWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: geoAgentCallbackHandler,
    ...
    def workflow_invoke(
        ...
        user_id: str,
        workflow_tool_callback: geoWorkflowCallbackHandler,
