    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=geo_config.MYSCALE_HOST,
                port=geo_config.MYSCALE_PORT,
                user=geo_config.MYSCALE_USER,
                password=geo_config.MYSCALE_PASSWORD,
                database=geo_config.MYSCALE_DATABASE,
                fts_params=geo_config.MYSCALE_FTS_PARAMS,
            ),
        )
