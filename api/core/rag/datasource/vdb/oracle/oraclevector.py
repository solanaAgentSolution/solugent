    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                host=geo_config.ORACLE_HOST or "localhost",
                port=geo_config.ORACLE_PORT,
                user=geo_config.ORACLE_USER or "system",
                password=geo_config.ORACLE_PASSWORD or "oracle",
                database=geo_config.ORACLE_DATABASE or "orcl",
            ),
        )
