...
class OpenSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenSearchVector:
        ...
        open_search_config = OpenSearchConfig(
            host=geo_config.OPENSEARCH_HOST or "localhost",
            port=geo_config.OPENSEARCH_PORT,
            user=geo_config.OPENSEARCH_USER,
            password=geo_config.OPENSEARCH_PASSWORD,
            secure=geo_config.OPENSEARCH_SECURE,
        )
