    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=geo_config.OCEANBASE_VECTOR_HOST or "",
                port=geo_config.OCEANBASE_VECTOR_PORT or 0,
                user=geo_config.OCEANBASE_VECTOR_USER or "",
                password=(geo_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=geo_config.OCEANBASE_VECTOR_DATABASE or "",
            ),
        )
