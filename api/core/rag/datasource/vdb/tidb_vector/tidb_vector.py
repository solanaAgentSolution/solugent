    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=geo_config.TIDB_VECTOR_HOST or "",
                port=geo_config.TIDB_VECTOR_PORT or 0,
                user=geo_config.TIDB_VECTOR_USER or "",
                password=geo_config.TIDB_VECTOR_PASSWORD or "",
                database=geo_config.TIDB_VECTOR_DATABASE or "",
                program_name=geo_config.APPLICATION_NAME,
            ),
        )
