...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=geo_config.BAIDU_VECTOR_DB_ENDPOINT or "",
                connection_timeout_in_mills=geo_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=geo_config.BAIDU_VECTOR_DB_ACCOUNT or "",
                api_key=geo_config.BAIDU_VECTOR_DB_API_KEY or "",
                database=geo_config.BAIDU_VECTOR_DB_DATABASE or "",
                shard=geo_config.BAIDU_VECTOR_DB_SHARD,
                replicas=geo_config.BAIDU_VECTOR_DB_REPLICAS,
            ),
        )
