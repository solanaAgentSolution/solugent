...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=geo_config.CHROMA_HOST or "",
                port=geo_config.CHROMA_PORT,
                tenant=geo_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=geo_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=geo_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=geo_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
