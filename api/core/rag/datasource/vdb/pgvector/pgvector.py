    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=geo_config.PGVECTOR_HOST or "localhost",
                port=geo_config.PGVECTOR_PORT,
                user=geo_config.PGVECTOR_USER or "postgres",
                password=geo_config.PGVECTOR_PASSWORD or "",
                database=geo_config.PGVECTOR_DATABASE or "postgres",
                min_connection=geo_config.PGVECTOR_MIN_CONNECTION,
                max_connection=geo_config.PGVECTOR_MAX_CONNECTION,
            ),
        )
