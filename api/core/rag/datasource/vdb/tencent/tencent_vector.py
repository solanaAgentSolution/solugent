    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=geo_config.TENCENT_VECTOR_DB_URL or "",
                api_key=geo_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=geo_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=geo_config.TENCENT_VECTOR_DB_USERNAME,
                database=geo_config.TENCENT_VECTOR_DB_DATABASE,
                shard=geo_config.TENCENT_VECTOR_DB_SHARD,
                replicas=geo_config.TENCENT_VECTOR_DB_REPLICAS,
            ),
        )
