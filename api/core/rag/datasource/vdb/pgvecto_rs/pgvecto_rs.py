    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVectoRS:
        ...
        return PGVectoRS(
            ...
            config=PgvectoRSConfig(
                host=geo_config.PGVECTO_RS_HOST or "localhost",
                port=geo_config.PGVECTO_RS_PORT or 5432,
                user=geo_config.PGVECTO_RS_USER or "postgres",
                password=geo_config.PGVECTO_RS_PASSWORD or "",
                database=geo_config.PGVECTO_RS_DATABASE or "postgres",
            ),
            dim=dim,
        )
