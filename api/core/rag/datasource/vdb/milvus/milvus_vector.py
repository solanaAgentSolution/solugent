...
class MilvusVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            collection_name=collection_name,
            config=MilvusConfig(
                uri=geo_config.MILVUS_URI or "",
                token=geo_config.MILVUS_TOKEN or "",
                user=geo_config.MILVUS_USER or "",
                password=geo_config.MILVUS_PASSWORD or "",
                database=geo_config.MILVUS_DATABASE or "",
            ),
        )
