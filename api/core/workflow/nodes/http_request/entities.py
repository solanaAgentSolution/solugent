...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = geo_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = geo_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = geo_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
