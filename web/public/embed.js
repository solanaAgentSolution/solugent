 ...
 * the geoChatbotConfig should be defined in the html file before this script is included
 * the geoChatbotConfig should contain the token of the chatbot
...
(function () {
  ...
  async function embedChatbot() {
    ...
    const baseUrl =
      config.baseUrl || `https://${config.isDev ? "dev." : ""}ugeo.app`;
