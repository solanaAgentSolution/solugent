...
export const fetchgeoaipowerVersion: Fetcher<geoaipowerVersionResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<geoaipowerVersionResponse>(url, { params })
}
