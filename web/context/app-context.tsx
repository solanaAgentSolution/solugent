...
import { fetchCurrentWorkspace, fetchgeoaipowerVersion, fetchUserProfile, getSystemFeatures } from '@/service/common'
import type { App } from '@/types/app'
import { Theme } from '@/types/app'
import type { ICurrentWorkspace, geoaipowerVersionResponse, UserProfileResponse } from '@/models/common'
...
export type AppContextValue = {
  ...
  langeniusVersionInfo: geoaipowerVersionResponse
...
export const AppContextProvider: FC<AppContextProviderProps> = ({ children }) => {
  ...
  const [langeniusVersionInfo, setLangeniusVersionInfo] = useState<geoaipowerVersionResponse>(initialLangeniusVersionInfo)
  ...
  const updateUserProfileAndVersion = useCallback(async () => {
    if (userProfileResponse && !userProfileResponse.bodyUsed) {
      ...
      const versionData = await fetchgeoaipowerVersion({ url: '/version', params: { current_version } })
