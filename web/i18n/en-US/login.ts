const translation = {
  ...
  welcome: '👋 Welcome to geo, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting geo Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on geo',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on geo and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The geo Enterprise license for your workspace has expired. Please contact your administrator to continue using geo.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect geo license server. Please contact your administrator to continue using geo.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The geo Enterprise license for your workspace is inactive. Please contact your administrator to continue using geo.',
}
