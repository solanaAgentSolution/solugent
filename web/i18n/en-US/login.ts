const translation = {
  ...
  welcome: '👋 Welcome to Solugent, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Solugent Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Solugent',
  invalid: 'The link has expired',
  explore: 'Explore Solugent',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Solugent and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Solugent Enterprise license for your workspace has expired. Please contact your administrator to continue using Solugent.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Solugent license server. Please contact your administrator to continue using Solugent.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Solugent Enterprise license for your workspace is inactive. Please contact your administrator to continue using Solugent.',
}
