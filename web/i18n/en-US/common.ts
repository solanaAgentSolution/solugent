const translation = {
  ...
  account: {
    ...
    solugentAccount: 'Solugent account',
    solugentAccountTip: 'Your Solugent account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Solugent to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Solugent allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Solugent\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.solugent.org/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Solugent {{version}} is now available.',
    latestAvailable: 'Solugent {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
