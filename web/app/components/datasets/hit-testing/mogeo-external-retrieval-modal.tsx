...
type MogeoExternalRetrievalModalProps = {
  onClose: () => void
...
const MogeoExternalRetrievalModal: React.FC<MogeoExternalRetrievalModalProps> = ({
  onClose,
  onSave,
  initialTopK,
...
export default MogeoExternalRetrievalModal
